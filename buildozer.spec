...
title = MinusTimesMinus

# (str) Package name
package.name = minustimesminus

# (str) Package domain (needed for android/ios packaging)
package.domain = com.gmail.GermanShepherdAreSoCute
...
presplash.filename = %(source.dir)s/third_parties_images/navagio_adapt.png

# (str) Icon of the application
icon.filename = %(source.dir)s/own_images/minustimesminus_icon.png
